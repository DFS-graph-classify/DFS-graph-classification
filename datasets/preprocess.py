...
def mapping(path, dest):
    ...
    """
    print('Starting.. mapping in datasets/preprocess.py')
    ...
    print('Ending.. mapping in datasets/preprocess.py')
    return feature_map
...
def get_bfs_seq(G, start_id):
    ...
    """
    print('Starting.. get_bfs_seq in datasets/preprocess.py')
    ...
    print('Ending.. get_bfs_seq in datasets/preprocess.py')

    return output


def get_random_bfs_seq(graph):
    print('Starting.. get_random_bfs_seq in datasets/preprocess.py')
    ...
    print('Ending.. get_random_bfs_seq in datasets/preprocess.py')
    return [perm[bfs_seq[i]] for i in range(n)]


def graph_to_min_dfscode(graph_file, graphs_path, min_dfscodes_path, temp_path):

    print('Starting.. graph_to_min_dfscode in datasets/preprocess.py')
...
def graphs_to_min_dfscodes(graphs_path, min_dfscodes_path, temp_path):
    ...
    """
    print('Starting.. graphs_to_min_dfscodes in datasets/preprocess.py')
    graphs = []
...
def dfscode_to_tensor(dfscode, feature_map):
    print('Starting.. dfscode_to_tensor in datasets/preprocess.py')
    ...
    print('Ending.. dfscode_to_tensor in datasets/preprocess.py')
...
def dfscode_from_file_to_tensor_to_file(
    ...
    print('Starting.. dfscode_from_file_to_tensor_to_file in datasets/preprocess.py')
...
def min_dfscodes_to_tensors(min_dfscodes_path, min_dfscode_tensors_path, feature_map):
    ...
    :return: length of dataset
    """
    print('Starting.. min_dfscodes_to_tensors in datasets/preprocess.py')
    min_dfscodes = []
...
def calc_max_prev_node_helper(idx, graphs_path):
    print('Starting.. calc_max_prev_node_helper in datasets/preprocess.py')
...
def calc_max_prev_node(graphs_path):
    ...
    """
    print('Starting.. calc_max_prev_node in datasets/preprocess.py')
    max_prev_node = []
...
def dfscodes_weights(dataset_path, graph_list, feature_map, device):
    print('Starting.. dfscodes_weights in datasets/preprocess.py')
    freq = {
...
def random_walk_with_restart_sampling(
    ...
    print('Starting.. random_walk_with_restart_sampling in datasets/preprocess.py')
